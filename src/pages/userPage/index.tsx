      ...
      <div className="bg-black h-screen">
        <div className="flex flex-row lg:border lg:border-solid lg:border-slate-900 lg:bg-zinc-700 ">
          ...
          <div className="flex mt-4">
            ...
            <p className="lg:text-xl text-white mt-4 lg:mt-10 ml-2 ">Profile</p>
            <p className="m-2  text-3xl text-white  lg:text-4xl">Name of user</p>
            </div>
          </div>
        </div>
        <div className="flex flex-row ">
          <p className="text-white ml-7 text-xl lg:mt-6 lg:text-3xl ">Public List</p>
